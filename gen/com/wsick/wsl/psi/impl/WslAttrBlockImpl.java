...
public class WslAttrBlockImpl extends ASTWrapperPsiElement implements WslAttrBlock {

  public WslAttrBlockImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WslAttr> getAttrList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WslAttr.class);
  }
